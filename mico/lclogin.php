...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT Password FROM lclogin WHERE Email = ? AND Contact = ?";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        if ($password === $stored_password) {
            ...
            $message = "<span style='color: green;'>Login successful! </span><a href='lcDashboard.html' style='color: #0072ff; text-decoration: none;'>&#8594; Go to Dashboard</a>";
        } else {
            // Incorrect password
...
<body>
    ...
    <main>
        <div class="login-container">
            <h2>Login</h2>
            <form action="lclogin.php" method="POST">
