...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        // Successful login
        $message = "<span style='color: green;'>Login successful! </span><a href='fmDashboard.html' style='color: #0072ff; text-decoration: none;'>&#8594; Go to Dashboard</a>";
    } else {
        // Failed login
...
<body>
    ...
    <main>
        <div class="login-container">
            <h2>Login</h2>
            <form action="fmlogin.php" method="POST">
