...
<body>
    <div class="container">
        ...
        $sql = "SELECT * FROM lforder WHERE OrderID = $orderId";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div class='invoice-detail'><strong>IIC:</strong> " . $row['IIC'] . "</div>";
                ...
                echo "<div class='invoice-detail'><strong>Country:</strong> " . $row['Country'] . "</div>";
                echo "<div class='invoice-detail'><strong>Amount:</strong> " . $row['Amount'] . "</div>";
                echo "<div class='invoice-detail'><strong>Payment Status:</strong> " . $row['Payment'] . "</div>";
            }
        } else {
        ...
        <button onclick="window.location.href='vieworder2.php'">Back</button>
    </div>
</body>
</html>
