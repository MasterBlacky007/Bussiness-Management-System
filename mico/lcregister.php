...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!preg_match("/^[a-zA-Z\s]+$/", $fullname)) {
        $message = "<span style='color: red;'>Full name should contain only letters and spaces.</span>";
        ...
        try {
            ...
            $sql_register = "INSERT INTO lcregister (FullName, Email, Contact, Address, City,NIC) 
                             VALUES ('$fullname', '$email', '$contact', '$address', '$city','$nic')";
            $conn->query($sql_register);

            // Insert into `suplogin` table
            $sql_login = "INSERT INTO lclogin (Email, Contact, Password) 
...
<body>
    ...
    <main>
        <div class="container2">
            ...
            <form id="registration-form" action="lcregister.php" method="POST">
                ...
                <div class="login-link">
                    <p>Already have an account? <a href="lclogin.php">Login here</a></p>
                </div>
            </form>
        </div>
    </main>
