...
<form method="GET" action="" style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 20px;">
    ...
    <!-- Back Button -->
    <div style="flex: 0 1 150px;">
        <button type="button" onclick="window.location.href='viewcostreport1.html';" style="padding: 10px 20px; font-size: 1em; background-color: #2196F3; color: white; border: none; border-radius: 5px; cursor: pointer; width: 100%; transition: background-color 0.3s, transform 0.2s;">
            Back
        </button>
    </div>
</form>
...
<form method="POST" action="downloadpdf.php">
    ...
    <button type="submit" name="download_pdf" style="padding: 10px 20px; font-size: 1em; background-color: #4CAF50; color: white; border: none; border-radius: 5px; cursor: pointer; transition: background-color 0.3s;">
        Download PDF
    </button>
</form>
