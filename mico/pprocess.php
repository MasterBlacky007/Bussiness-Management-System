...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <link rel="stylesheet" href="salarystatus.css">
    <script>
...
<body>
     ...
     <main>
     <h1 class="head">Production Process</h1>

<form name="order" method="get" onsubmit="return validateForm(event)">
    <div>
        <input class="" type="text" name="search" placeholder="Search process ID">
...
$sql = "SELECT * FROM pprocess";

// Check if a search term is provided
if (isset($_GET['search']) && !empty($_GET['search'])) {
$searchTerm = $conn->real_escape_string($_GET['search']);
$sql .= " WHERE ppid LIKE '%$searchTerm%'";
}
...
echo "<tr><td colspan='7'>No processID found.</td></tr>";
}
